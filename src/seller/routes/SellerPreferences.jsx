            ...
            <div>
              ...
              <input
                ...
                onChange={(event) => {
                  ...
                  updateField("shopName", nextValue.slice(0, SHOP_NAME_MAX_LENGTH));
                }}
                ...
                pattern="[A-Za-z0-9]+"
              />
              {validateShopName(preferencesForm.shopName) ? (
                <p className="mt-1 text-xs text-red-600">{validateShopName(preferencesForm.shopName)}</p>
              ) : (
